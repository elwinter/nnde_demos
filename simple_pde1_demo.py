"""Demonstration of use of nnde to solve simple PDE IVP."""
...
if __name__ == '__main__':
    ...
    eq_module = 'nnde.differentialequation.examples.simple_pde1'
