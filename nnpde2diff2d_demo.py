"""Demo program for solving 2-D diffusion problems with nnde"""
...
# Specify the number of nodes in the hidden layer.
H = 10
...
pde = "nnde.differentialequation.examples.diff2d_halfsine"
...
n = len(x_train)
if training_opts['verbose']:
    print("Using %s training points." % n)
